...
var file_chat_response_proto_rawDesc = []byte{
	0x0a, 0x13, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x77, 0x61, 0x70, 0x70, 0x2e, 0x63, 0x68, 0x61, 0x74,
...
var file_chat_response_proto_goTypes = []any{
	(*PingResponse)(nil), // 0: wapp.chat.PingResponse
}
...
func file_chat_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chat_response_proto_msgTypes[0].Exporter = func(v any, i int) any {
